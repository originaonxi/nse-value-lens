...
app.get('/data/:name(swing_desk|swing_evidence|expanded_research|cross_asset_research|futures_research|research_data_audit|indicator_research|hhhl_scan|hhhl_refresh_status|vcp_scan|vcp_refresh_status|market_brief|market_brief_refresh_status).json', async (req, res) => {
  try {
