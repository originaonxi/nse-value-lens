...
app.get('/data/:name(swing_desk|swing_evidence|expanded_research|cross_asset_research|futures_research|research_data_audit|indicator_research).json', async (req, res) => {
  try {
